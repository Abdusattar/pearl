...
# «пучок» и «бут» уже стоят у товаров в базе, но в списке их не было — форма
# закупа заставляла выбрать что-то другое, и зелень уходила в килограммы
# (10.09: укроп и петрушка приходовались по 15–18 сом за «кг» при реальной цене
# килограмма втрое выше — это была цена пучка). Единица, которой пользуются,
# должна быть в списке, иначе разнобой воспроизводится на каждом чеке.
UNITS = ["кг", "л", "шт", "г", "уп", "пач", "пучок", "бут"]
...
UNITS_NEED_GRAMS_PER_UNIT = {"шт", "уп", "пач", "пучок", "бут"}
