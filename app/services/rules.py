...
RULES = {
    ...
    # Закрытие дня (владелец 24.09): люди уходят в 17:30 — требовать заранее, к вечеру всё выверено
    "close_check_time": {"default": "15:00", "title": "Проверка закрытия дня (группа, каждому по имени)"},
    "close_manager_time": {"default": "16:00", "title": "Незакрытое — заведующей в личку"},
    "close_remind_time": {"default": "16:45", "title": "Незакрытое — заведующей в группе"},
